...
const tiers = [
  ...
  },
  {
    ...
    features: [
      ...
      "Full voice assistant access",
      "AI scheduling & coordination",
      "Smart household automation",
      "School/activity reminders",
      "Smart routines (morning, bedtime, etc.)",
      "Location-based reminders",
      "Integration support (Alexa, Google, iOS)",
      "Family insights & suggestions",
    ],
    limits: [],
    voiceNote: "High voice usage included",
