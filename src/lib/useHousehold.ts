...
export const TIER_INFO: Record<Tier, { label: string; price: number; logins: number; minutes: number; seconds: number }> = {
  basic: { label: "Basic", price: 7.99, logins: 1, minutes: 30, seconds: 1800 },
  family: { label: "Family", price: 22.99, logins: 4, minutes: 120, seconds: 7200 },
  family_plus: { label: "Family Plus", price: 35.99, logins: 6, minutes: 240, seconds: 14400 },
};
