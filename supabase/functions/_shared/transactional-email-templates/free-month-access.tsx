...
const FreeMonthAccessEmail = ({ firstName, endsOn }: FreeMonthProps) => {
  ...
  return (
    <Html lang="en" dir="ltr">
      <Head />
      <Preview>Your free month of Mia is unlocked — no plan or card needed</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={card}>
            <Heading style={h1}>Enjoy a free month, on us</Heading>
            <Text style={text}>{greeting}</Text>
            <Text style={text}>
              You created a {SITE_NAME} account but never picked a plan, so
              we've unlocked everything for you for a full month — free. No plan
              selection, no card, nothing to buy.
            </Text>
            <Text style={text}>
              Just sign in with this email address and start using it
              {endsOn ? `. Your free month runs through ${endsOn}.` : '.'}
            </Text>
          ...
          <Section>
            ...
            <Text style={bodyText}>
              ...
              in sync across everyone in your household. When the free month
              ends you can choose a plan if you'd like to keep going; nothing
...
export const template = {
  component: FreeMonthAccessEmail,
  subject: 'Your free month of Mia is unlocked',
  displayName: 'Free month access',
  previewData: { firstName: 'Alex', endsOn: 'October 17, 2026' },
